...
public class CLabsImageSlider:UIView,updateUI
{
    ...
    var scW = UIScreen.main.bounds.width
    ...
    var rightFrame  :CGRect
    {
        ...
        return CGRect(x:scW + 60, y:0, width:scW + 70, height:self.frame.size.height)
    }
    
    var midFrame    :   CGRect
    {
        return CGRect(x:0, y:0,width: scW,height: self.frame.size.height)
    }
    ...
    func enableArrows()
    {
        ...
        path.move(to: CGPoint(x:screenW-16, y:self.frame.size.height/2-10))
        path.addLine(to: CGPoint(x:screenW-8,y: self.frame.size.height/2))
        path.addLine(to: CGPoint(x:screenW-16,y: self.frame.size.height/2+10))
        shape.lineWidth =   2.0
...
//        self.layer.addSublayer(shape)
        ...
        path1.move(to: CGPoint(x:screenW-18, y:self.frame.size.height/2-10))
        path1.addLine(to: CGPoint(x:screenW-10,y: self.frame.size.height/2))
        path1.addLine(to: CGPoint(x:screenW-18, y:self.frame.size.height/2+10))
...
//        self.layer.addSublayer(shape3)
        ...
        rightBtn.frame  =   CGRect(x:screenW-26, y:self.frame.size.height/2-15,width: 20, height:30)
